...
export default function PlayerProfile() {
  ...
  // member data is passed via route state from ClubManagement
  const [member, setMember] = useState(state?.member || {
    id: null, name: 'Unknown Member', email: '—', phone: '—',
    emergencyContact: '—', dateOfBirth: '—', team: '—',
    position: '—', attendanceRate: '—', payment: '—', nextPayment: '—',
  });
  ...
  return (
    <div className="pp-container">
      ...
      <div className="pp-card">
        {/* Volleyball watermark inside card */}
        ...
        <div className="pp-card-footer">
          <button className="pp-edit-btn" onClick={() => { setForm({...member}); setEditOpen(true); }}>
            Edit <span>✎</span>
          </button>
        </div>
      </div>
        ...
        <div className="pp-modal-overlay" onClick={() => setEditOpen(false)}>
          <div className="pp-modal" onClick={e => e.stopPropagation()}>
            ...
            <form onSubmit={saveEdit}>
              ...
              <div className="pp-form-row">
                <FormField label="Team"               value={f('team')}             onChange={v => setForm({...form, team: v})}             type="text" />
